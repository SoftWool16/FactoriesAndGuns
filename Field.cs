    ...
    internal class Field
    {
        ...
        public Field (string name, int sizeX, int sizeY)
        {
            ...
            for (int i = 0; i < sizeY; i++)
            {
                ...
                {
                    if (i == j) Fields[i, j] = new Element("Void", i, j, "C:\\Users\\TOP\\Desktop\\модельки для MyMindustry\\static_block\\point.png");
                    else if (i % 10 == 0 && j % 10 == 0) Fields[i, j] = new Element("Void", i, j, "C:\\Users\\TOP\\Desktop\\модельки для MyMindustry\\static_block\\grass.png");
